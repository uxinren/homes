...
const refDetailList = ref([
  ...
  {date: '01-04', content: '买书', amount: 20, tag: '临时支出'}
]);
const refAreaChartData = ref([]);
const refArcbarChartData = ref({});
...
const getServerData = () => {
  ...
  setTimeout(() => {
    ...
    refAreaChartData.value = JSON.parse(JSON.stringify(resArea));
    refArcbarChartData.value = JSON.parse(JSON.stringify(resArcbar));
  }, 500);
};
  ...
  <view class="content">
    <view class="box">
      <view class="box-title">
        ...
        <navigator open-type="navigate" hover-class='none'
                   :url="'./statistics?type=' + encodeURIComponent(JSON.stringify(refAreaChartData))"
        >
      ...
      <view class="chart-box" style="height: 15vh;">
        <qiun-data-charts type="cusArea" :chartData="refAreaChartData" :canvas2d="true"
    ...
    <view class="box">
      <view class="box-title">
        ...
        <navigator open-type="navigate" hover-class='none'
                   :url="'./record?type=' + encodeURIComponent(JSON.stringify(refAreaChartData))"
        >
          <text class="icon-right">&#xe769;</text>
        </navigator>
      </view>
      <view class="chart-box">
        <view v-for="(item,index) in refDetailList" :key="index" class="list-wraper">
    ...
    <view class="add" @click="openKeyboard">
